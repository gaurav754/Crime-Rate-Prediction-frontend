          ...
          <div className="hero-content">
            ...
            >
              ...
              <div className="hero-buttons">
                ...
                >
                  <button 
                    onClick={() => window.open('https://crimeprediction-3pdnhtrky5sakrqtpzqqyi.streamlit.app/', '_blank')}
          ...
          <div className="features-grid">
            {[
              ...
              <motion.div
                ...
                onClick={feature.title === 'Crime Prediction' ? 
                  () => window.open('https://crimeprediction-3pdnhtrky5sakrqtpzqqyi.streamlit.app/', '_blank') : 
